        ...
        <div class="row">
                ...
                >
                    ...
                    <BaseBlock title="Inbox">
                        <template #options>
                            ...
                            >
                                <i class="fa fa-pencil-alt me-1 opacity-50"></i>
                                Compose
                            </button>
                        </template>
                        ...
                        <ul class="nav nav-pills flex-column push">
                            <li class="nav-item my-1">
                                ...
                                >
                                    <span class="fs-sm">
                                        <i
                                            class="fa fa-fw fa-inbox me-1 opacity-50"
                                        ></i>
                                        Inbox
                                    </span>
                            ...
                            <li class="nav-item my-1">
                                ...
                                >
                                    <span class="fs-sm">
                                        <i
                                            class="fa fa-fw fa-star me-1 opacity-50"
                                        ></i>
                                        Starred
                                    </span>
                                    <span class="badge rounded-pill bg-black-50"
                            ...
                            <li class="nav-item my-1">
                                ...
                                >
                                    <span class="fs-sm">
                                        <i
                                            class="fa fa-fw fa-paper-plane me-1 opacity-50"
                                        ></i>
                                        Sent
                                    </span>
                                    <span class="badge rounded-pill bg-black-50"
                            ...
                            <li class="nav-item my-1">
                                ...
                                >
                                    <span class="fs-sm">
                                        <i
                                            class="fa fa-fw fa-pencil-alt me-1 opacity-50"
                                        ></i>
                                        Draft
                                    </span>
                                    <span class="badge rounded-pill bg-black-50"
                            ...
                            <li class="nav-item my-1">
                                ...
                                >
                                    <span class="fs-sm">
                                        <i
                                            class="fa fa-fw fa-folder me-1 opacity-50"
                                        ></i>
                                        Archive
                                    </span>
                                    <span class="badge rounded-pill bg-black-50"
                            ...
                            <li class="nav-item my-1">
                                ...
                                >
                                    <span class="fs-sm">
                                        <i
                                            class="fa fa-fw fa-trash-alt me-1 opacity-50"
                                        ></i>
                                        Trash
                                    </span>
                                    <span class="badge rounded-pill bg-black-50"
                    ...
                    <BaseBlock title="Account">
                        ...
                        >
                            ...
                            >
                                <div class="push">
                                    <i
                                        class="si si-like fa-2x text-success"
                                    ></i>
                                </div>
                                <div class="fs-2 fw-bold">
                                    <span class="text-muted">+</span> 2.5TB
                                </div>
                                <div class="fs-sm text-muted text-uppercase">
                                    Upgrade Now
                                </div>
                            </div>
                        </BaseBlock>
            ...
            <div class="col-md-7 col-xl-9">
                ...
                <BaseBlock content-class="py-0" btn-option-fullscreen>
                    <template #title>
                        15-30
                        <span class="fw-normal text-lowercase">from</span> 700
                    </template>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            We are glad you decided to go with a
                                            vip..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            An update is under way for your
                                            app..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            Your account is inactive for a long
                                            time and..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            Our new photo pack is available now!
                                            You..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            This is a notification about our new
                                            product..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            Our Book is out! You can buy a copy
                                            and..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            The monthly report you requested
                                            for..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            You 30-day trial has now started
                                            and..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            This is the invoice for the project
                                            we..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            You have a new friend request. Click
                                            the..
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                        <div class="text-muted mt-1">
                                            Due to the fact that you are a
                                            great..
                                        </div>
                                    </td>
                                    <td
                ...
                <div class="modal-content">
                    <form @submit.prevent>
                        <BaseBlock transparent class="mb-0">
                            <template #title>
                                <i class="fa fa-pencil-alt me-1"></i> New
                                Message
                            </template>
                            ...
                            <template #content>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            class="fa fa-paper-plane me-1 opacity-50"
                                        ></i>
                                        Send Message
                                    </button>
                                </div>
                        ...
                        <template #content>
                            ...
                            <div class="block-content bg-body-light">
                                <div class="row g-sm items-push fs-sm">
                                    <div class="col-md-4">
                                        <div
                                            class="options-container fx-item-zoom-in mb-2"
                                        >
                                            <img
                                            ...
                                            />
                                            <div
                                                class="options-overlay bg-black-75"
                                            >
                                                <div
