...
const getCategoriesList = async () => {
    await $axios
        ...
        .then((response) => {
            state.categoriesList = response.data.data;
        })
        .catch((error) => {
            if (error.response) {
                return toast.fire(
...
<template>
    <div class="content">
        <div class="row">
            <div class="col-6">
                <BaseBlock title="Create Sub-Category">
                    <div class="row">
                        <div class="col-6 d-flex align-items-center">
                            <div class="mb-3">
                                <button
                                    ...
                                    data-bs-target="#modal-create-subcategory"
                                >
                                    <i>Create Sub-Category</i>
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <BaseBlock title="Sub-Categories List">
            <template #options>
                <button
                    type="button"
                    class="btn-block-option"
                    @click="getSubcategoriesList()"
                ></button>
            </template>
        ...
        <div
            ...
            tabindex="-1"
            role="dialog"
            aria-labelledby="modal-create-subcategory"
            aria-hidden="true"
        >
